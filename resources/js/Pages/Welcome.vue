...
<template>
    <MainLayout :isAuthenticated="isAuthenticated" :userName="userName"> 
      ...
      <div class="flex h-screen items-center justify-center bg-background text-text/50 transition-colors duration-250 overflow-hidden">
        <div class="w-full max-w-3xl p-4">
          <div class="rounded bg-background p-6 text-center shadow-lg transition-colors duration-250">
